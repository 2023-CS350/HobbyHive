...
class _TabBarScrollPosition extends ScrollPositionWithSingleContext {
  ...
  final _HobbyHiveButtonTabBarState tabBar;
...
class HobbyHiveButtonTabBar extends StatefulWidget
  ...
  /// and the entire [HobbyHiveButtonTabBar] is scrollable. Otherwise each tab gets an equal
  ...
  @override
  State<HobbyHiveButtonTabBar> createState() =>
      _HobbyHiveButtonTabBarState();
}

class _HobbyHiveButtonTabBarState extends State<HobbyHiveButtonTabBar>
  ...
  @override
  void didUpdateWidget(HobbyHiveButtonTabBar oldWidget) {
