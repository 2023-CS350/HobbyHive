...
Widget wrapWithModel<T extends HobbyHiveModel>({
  required T model,
...
T createModel<T extends HobbyHiveModel>(
...
class HobbyHiveDynamicModels<T extends HobbyHiveModel> {
  HobbyHiveDynamicModels(this.defaultBuilder);
