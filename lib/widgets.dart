...
class HobbyHiveButtonOptions {
  const HobbyHiveButtonOptions({
    this.textStyle,
    this.elevation,
    this.height,
    this.width,
...
class HobbyHiveButtonWidget extends StatefulWidget {
  const HobbyHiveButtonWidget({
    Key? key,
    required this.text,
  ...
  final HobbyHiveButtonOptions options;
  final bool showLoadingIndicator;

  @override
  State<HobbyHiveButtonWidget> createState() => _HobbyHiveButtonWidgetState();
}

class _HobbyHiveButtonWidgetState extends State<HobbyHiveButtonWidget> {
  bool loading = false;
