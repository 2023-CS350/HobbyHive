...
abstract class HobbyHiveTheme {
  static HobbyHiveTheme of(BuildContext context) {
...
class LightModeTheme extends HobbyHiveTheme {
  @Deprecated('Use primary instead')
  Color get primaryColor => primary;
  @Deprecated('Use secondary instead')
  Color get secondaryColor => secondary;
  ...
  late Color primary = const Color(0xFFD8AB5D);
  late Color secondary = const Color(0xFF281600);
  late Color tertiary = const Color(0xFFE8C078);
